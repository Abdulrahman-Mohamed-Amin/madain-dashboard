...
export class AddProjectsComponent implements OnInit {
  ...
  addForm: FormGroup = new FormGroup({
    ...
    arLocationDescription: new FormControl('', [Validators.pattern(this.arabicPattern) , Validators.required]),
    enLocationDescription: new FormControl('', [Validators.pattern(this.englishPattern) , Validators.required]),
